...
const AddDoctor = () => {
    ...
    const { data: services, isLoading } = useQuery('services', () => fetch('https://glacial-atoll-10131.herokuapp.com/service').then(res => res.json()));

    const imageStorageKey = 'b590bbba05b66d7bd730e0d531944391';
    /**
     * 3 ways to store images
     * a.Third party storage like img bb// Free open public storage is ok for Practice project 
        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    fetch('https://glacial-atoll-10131.herokuapp.com/doctor', {
                        method: 'POST',
                        headers: {
